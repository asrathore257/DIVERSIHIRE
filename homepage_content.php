...
<main>
        <div class="slider-area >
            <div class="slider-active">
                <div class="single-slider slider-height d-flex align-items-center h-img"  data-background="assets/img/poster.jpg" >
                    <div class="container">
                            ...
                            <div class="col-xl-10">
                                ...
                                <form action="search.quick.php" method="post" class="search-box" name="form_quicksearch" onsubmit="return QuickSearchValidate()">
                                    <div class="input-form">
                                        <input type="textarea" name ="quick_key" id="jobsearch" placeholder="Job Tittle or keyword">
                                    ...
                                    <div class="search-form">
                                        <button type="submit" class=" head-btn2 btn5">Find job</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="our-services section-pad-t30 " style="
